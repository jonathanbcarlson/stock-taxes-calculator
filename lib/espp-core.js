...
// Default plan purchase discount. IRC §423(c)(1) caps qualifying ordinary income at
// this rate applied to the GRANT date FMV, so the rate matters even though the app
// takes the purchase price directly. 15% is the statutory maximum (§423(b)(6)) and by
// far the most common plan design, so it is the default; callers pass discountRate for
// plans that discount less. The UI collects it in the "Plan Discount" field.
